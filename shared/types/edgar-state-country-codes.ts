 ...
 * Source: SEC EDGAR state/country code list
 */

export const EdgarStateCountryCode = {
  "AL" : "ALABAMA",
  "AK" : "ALASKA",
  "AZ" : "ARIZONA",
  "AR" : "ARKANSAS",
...
export type EdgarStateCountryCodeValue = keyof typeof EdgarStateCountryCode;

export const EDGAR_STATE_COUNTRY_CODES = Object.keys(
  EdgarStateCountryCode,
) as EdgarStateCountryCodeValue[];

export function isEdgarStateCountryCode(
  value: string,
): value is EdgarStateCountryCodeValue {
  return value in EdgarStateCountryCode;
}

export function getEdgarStateCountryName(
  code: EdgarStateCountryCodeValue | string,
): string | undefined {
  if (isEdgarStateCountryCode(code)) {
    return EdgarStateCountryCode[code];
  }
  return undefined;
}
